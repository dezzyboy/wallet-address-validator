...
describe('WAValidator.validate()', function () {
    describe('valid results', function () {
        ...
        it('should return true for correct averopay addresses', function () {
            valid('AbJb4bKgmUuFzGFmETgdPm6amf72ikaczo', 'averopay');
            valid('AJi4DGP4hCphHHC54CFbZpg1YcQc3ztrtv', 'averopay');
            valid('AJi4DGP4hCphHHC54CFbZpg1YcQc3ztrtv', 'AOP');
            valid('AJi4DGP4hCphHHC54CFbZpg1YcQc3ztrtv', 'Averopay');
            valid('AJi4DGP4hCphHHC54CFbZpg1YcQc3ztrtv', 'aop');
            valid('AJi4DGP4hCphHHC54CFbZpg1YcQc3ztrtv', 'aop', 'prod');
            valid('AJi4DGP4hCphHHC54CFbZpg1YcQc3ztrtv', 'aop', 'prod');
            valid('AYEEGscGEhwR8KPrXQyuw1cvQQcV834Kzv', 'averopay');
            valid('AVAeQxk5PyEnxQQYJTd7HESC8nSoNyw8VS', 'averopay', 'prod');
            valid('ANuag82CAvfWzaPMb9yH5WxLeVvzxU1GEC', 'averopay', 'prod');

            valid('AKoruwxvDc15DQtmRnwHLiqXVRdJgUJxAU');
            valid('ASFQtgaFZSs5uE12117zRJZ9mMAMjrX8Wt');

            // p2sh addresses
            valid('AYEEGscGEhwR8KPrXQyuw1cvQQcV834Kzv');
            valid('AYEEGscGEhwR8KPrXQyuw1cvQQcV834Kzv', 'averopay');
        });
